...
// Type: OnyxServer.xmpp.query.GameRoom_QuickPay_Cancel
...
{
  public class GameRoom_QuickPay_Cancel : Stanza
  {
      ...
      : base(_User, _Packet)
    {
      ...
      XElement xelement3 = new XElement((XName) "gameroom_quickplay_cancel");

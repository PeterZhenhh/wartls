...
// Type: OnyxServer.xmpp.query.PersistentSettingsGet
...
{
  public class PersistentSettingsGet : Stanza
  {
    ...
    public override void Process()
    {
      ...
      XElement xelement3 = new XElement((XName) "persistent_settings_get");
      if (this.User.Player.Settings.ChildNodes.Count != 0)
      {
        foreach (XmlNode childNode in this.User.Player.Settings["settings"].ChildNodes)

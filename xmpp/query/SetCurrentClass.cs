...
// Type: OnyxServer.xmpp.query.SetCurrentClass
...
{
  public class SetCurrentClass : Stanza
  {
    ...
    public SetCurrentClass(Client User, XmlDocument Packet)
      : base(User, Packet)
    {
      User.Player.CurrentClass = byte.Parse(this.Query.Attributes["current_class"].InnerText);
      this.Process();
    }
    ...
    public override void Process()
    {
      ...
      XElement xelement3 = new XElement((XName) "setcurrentclass");

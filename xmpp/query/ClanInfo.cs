...
// Type: OnyxServer.xmpp.query.ClanInfo
...
{
  public class ClanInfo : Stanza
  {
    public ClanInfo(Client User, XmlDocument Packet = null)
      : base(User, Packet)
    {
      this.Process();
    }
    ...
    public override void Process()
    {
      ...
      if (this.User.Player.Clan.ID != 0L)
        xelement3.Add((object) this.User.Player.Clan.Serialize(this.User));
